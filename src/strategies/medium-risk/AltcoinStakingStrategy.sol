...
/**
 * @title AltcoinStakingStrategy
 * @notice Medium Risk Strategy - Simulates altcoin staking
 * @dev Moderate APY: 8-12%
 */
contract AltcoinStakingStrategy is ERC4626, Ownable, ReentrancyGuard {
    ...
    constructor(
        IERC20 _asset
    ) ERC4626(_asset) ERC20("Altcoin Staking Shares", "sALT") Ownable(msg.sender) {
    ...
    function _generateYield() internal {
        ...
        uint256 randomFactor = (randomSeed % 30) + 90; // 90-120
