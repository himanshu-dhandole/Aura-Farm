...
/**
 * @title DeFiLendingStrategy
 * @notice Medium Risk Strategy - Simulates DeFi lending protocols
 * @dev Moderate APY: 6-10%
 */
contract DeFiLendingStrategy is ERC4626, Ownable, ReentrancyGuard {
    ...
    uint256 public baseAPY = 800; // 8% base APY
    ...
    constructor(
        IERC20 _asset
    ) ERC4626(_asset) ERC20("DeFi Lending Shares", "sDEFI") Ownable(msg.sender) {
    ...
    function _generateYield() internal {
        ...
        uint256 randomFactor = (randomSeed % 30) + 90; // 90-120 (±15%)
