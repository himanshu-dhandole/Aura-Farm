...
/**
 * @title BTCStrategy
 * @notice Low Risk Strategy - Simulates BTC lending/staking
 * @dev Conservative APY: 3-5%
 */
contract BTCStrategy is ERC4626, Ownable, ReentrancyGuard {
    ...
    constructor(
        IERC20 _asset
    ) ERC4626(_asset) ERC20("BTC Strategy Shares", "sBTC") Ownable(msg.sender) {
    ...
    function _generateYield() internal {
        ...
        uint256 randomFactor = (randomSeed % 20) + 95; // 95-115 (±10%)
